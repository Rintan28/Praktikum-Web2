...
<head>
  ...
  <title>OLCHOP EHE~</title>
</head>

<body style="background-color: #d3eff0;">
  <div class="container-fluid">
      ...
      <div class="col-md-7">
        ...
        <form method="POST" action="form_belanja.php">
          <div class="form-group row">
            <label for="customer" class="col-4 col-form-label font-weight-bold">Customer</label>
            <div class="col-8">
    ...
    <hr color="blue"><br>
    <div class="row">
      <div class="col-md-3" style="border: 3px solid #064b86; background-color: #c6e5dc" >
          <?php
